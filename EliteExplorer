...
local function main()
	...
	ConsoleFrame["BackgroundColor3"] = Color3.fromRGB(52, 28, 28);
	...
	G2L["3"]["BackgroundColor3"] = Color3.fromRGB(42, 22, 22);
	...
	G2L["5"]["ScrollBarImageColor3"] = Color3.fromRGB(64, 33, 33);
	...
	G2L["backgroundOutput"]["BackgroundColor3"] = Color3.fromRGB(40, 20, 20);
	...
	G2L["a"]["TopImage"] = '';
	G2L["a"]["BackgroundColor3"] = Color3.fromRGB(40, 20, 20);
	...
	G2L["a"].ScrollBarImageColor3 = Color3.fromRGB(78, 40, 40)
	...
	G2L["c"]["Color"] = Color3.fromRGB(18, 10, 10);
	...
	G2L["10"]["BackgroundColor3"] = Color3.fromRGB(42, 22, 22);
	...
	G2L["11"]["PlaceholderColor3"] = Color3.fromRGB(115, 60, 60);
	...
	G2L["14"]["BackgroundColor3"] = Color3.fromRGB(64, 33, 33);
	...
	G2L["19"]["BackgroundColor3"] = Color3.fromRGB(64, 33, 33);
	...
	G2L["20"]["BackgroundColor3"] = Color3.fromRGB(64, 33, 33);
	...
	Console.Init = function()
		...
		if CtrlScroll == true then
			Console.CtrlScroll.BackgroundColor3 = Color3.fromRGB(112, 39, 39)
		elseif CtrlScroll == false then
			Console.CtrlScroll.BackgroundColor3 = Color3.fromRGB(63, 32, 32)
		end
		...
		if AutoScroll == true then
			Console.AutoScroll.BackgroundColor3 = Color3.fromRGB(112, 39, 39)
		elseif AutoScroll == false then
			Console.AutoScroll.BackgroundColor3 = Color3.fromRGB(63, 32, 32)
		end
...
local function main()
	...
	Explorer.NewListEntry = function(index)
		...
		-- FIX: Forward mouse wheel events from entry TextButtons to parent treeFrame
		-- TextButtons consume MouseWheel before it reaches the parent Frame,
		-- so we manually forward to the scrollbar
		newEntry.MouseWheelForward:Connect(function()
			if scrollV then scrollV:ScrollTo(scrollV.Index - scrollV.WheelIncrement) end
		end)
		newEntry.MouseWheelBackward:Connect(function()
			if scrollV then scrollV:ScrollTo(scrollV.Index + scrollV.WheelIncrement) end
		end)
		return newEntry
	end
...
return search]==]
	...
	Explorer.InitSearch = function()
		...
		local Tweens = {
			Start = TweenService:Create(SearchFrame.UIStroke, TweenInfo, { Color = Color3.fromRGB(160, 50, 50) }),
			End = TweenService:Create(SearchFrame.UIStroke, TweenInfo, { Color = Color3.fromRGB(46, 24, 24) })
		}
	...
	Explorer.InitEntryTemplate = function()
		entryTemplate = create({
			...
			{2,"Frame",{BackgroundColor3=Color3.fromRGB(112,39,39),BackgroundTransparency=1,BorderColor3=Color3.fromRGB(140,60,60),BorderSizePixel=0,Name="Indent",Parent={1},Position=UDim2.new(0,20,0,0),Size=UDim2.new(1,-20,1,0),}},
	...
	Explorer.UpdateSelectionVisuals = function()
		...
		if not holder then
			...
			local guiTemplate = create({
				...
				{2,"Frame",{BackgroundColor3=Color3.fromRGB(112,39,39),BorderSizePixel=0,Parent={1},Position=UDim2.new(0,-1,0,-1),Size=UDim2.new(1,2,0,1),}},
				{3,"Frame",{BackgroundColor3=Color3.fromRGB(112,39,39),BorderSizePixel=0,Parent={1},Position=UDim2.new(0,-1,1,0),Size=UDim2.new(1,2,0,1),}},
				{4,"Frame",{BackgroundColor3=Color3.fromRGB(112,39,39),BorderSizePixel=0,Parent={1},Position=UDim2.new(0,-1,0,0),Size=UDim2.new(0,1,1,0),}},
				{5,"Frame",{BackgroundColor3=Color3.fromRGB(112,39,39),BorderSizePixel=0,Parent={1},Position=UDim2.new(1,0,0,0),Size=UDim2.new(0,1,1,0),}},
			})
			Explorer.SelectionVisualGui = guiTemplate

			local boxTemplate = Instance.new("SelectionBox")
			boxTemplate.LineThickness = 0.03
			boxTemplate.Color3 = Color3.fromRGB(212, 175, 55)
		...
		for i,v in pairs(Explorer.SelectionVisualGui:GetChildren()) do
			v.BackgroundColor3 = Color3.fromRGB(212, 175, 55)
		end
	...
	Explorer.Init = function()
		...
		local explorerItems = create({
			...
			{2,"Frame",{BackgroundColor3=Color3.fromRGB(60,30,30),BorderSizePixel=0,Name="ToolBar",Parent={1},Size=UDim2.new(1,0,0,22),}},
			{3,"Frame",{BackgroundColor3=Color3.fromRGB(42,22,22),BorderColor3=Color3.fromRGB(35,17,17),BorderSizePixel=0,Name="SearchFrame",Parent={2},Position=UDim2.new(0,3,0,1),Size=UDim2.new(1,-6,0,18),}},
			...
			{6,"UIStroke",{Thickness=1.4,Parent={3},Color=Color3.fromRGB(46,24,24)}},
			{7,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(36,18,18),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="Reset",Parent={3},Position=UDim2.new(1,-17,0,1),Size=UDim2.new(0,16,0,16),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,}},
			...
			{9,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(36,18,18),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="Refresh",Parent={2},Position=UDim2.new(1,-20,0,1),Size=UDim2.new(0,18,0,18),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,Visible=false,}},
			...
			{11,"Frame",{BackgroundColor3=Color3.fromRGB(44,22,22),BorderSizePixel=0,Name="ScrollCorner",Parent={1},Position=UDim2.new(1,-16,1,-16),Size=UDim2.new(0,16,0,16),Visible=false,}},
...
local function main()
	...
	Lib.ScrollBar = (function()
		...
		local function createFrame(self)
			local newFrame = createSimple("Frame",{Style=0,Active=true,AnchorPoint=Vector2.new(0,0),BackgroundColor3=Color3.fromRGB(95,50,50),BackgroundTransparency=0,BorderColor3=Color3.new(0.10588236153126,0.16470588743687,0.20784315466881),BorderSizePixel=0,ClipsDescendants=false,Draggable=false,Position=UDim2.new(1,-16,0,0),Rotation=0,Selectable=false,Size=UDim2.new(0,16,1,0),SizeConstraint=0,Visible=true,ZIndex=1,Name="ScrollBar",})
		...
		local function new(hor)
			...
			obj:Texture({
				ThumbColor = Color3.fromRGB(68,35,35),
				ThumbSelectColor = Color3.fromRGB(90,45,45),
				ArrowColor = Color3.new(1,1,1),
				FrameColor = Color3.fromRGB(44,22,22),
				ButtonColor = Color3.fromRGB(90,45,45)
			})
			return obj
		end
	...
	Lib.Window = (function()
		...
		local theme = {
			MainColor1 = Color3.fromRGB(60,30,30),
			MainColor2 = Color3.fromRGB(48,26,26),
			Button = Color3.fromRGB(68,35,35)
		}
		...
		local createGui = function(self)
			local gui = create({
				...
				{3,"Frame",{BackgroundColor3=Color3.fromRGB(48,26,26),BorderSizePixel=0,Name="Content",Parent={2},Position=UDim2.new(0,0,0,20),Size=UDim2.new(1,0,1,-20),ClipsDescendants=true}},
				{4,"Frame",{BackgroundColor3=Color3.fromRGB(38,19,19),BorderSizePixel=0,Name="Line",Parent={3},Size=UDim2.new(1,0,0,1),}},
				{5,"TextButton",{Text="",AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(60,30,30),BorderSizePixel=0,Name="TopBar",Parent={2},Size=UDim2.new(1,0,0,20),}},
				...
				{7,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(36,18,18),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="Close",Parent={5},Position=UDim2.new(1,-18,0,2),Size=UDim2.new(0,16,0,16),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,}},
				...
				{10,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(36,18,18),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="Minimize",Parent={5},Position=UDim2.new(1,-36,0,2),Size=UDim2.new(0,16,0,16),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,}},
				...
				{15,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(78,40,40),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="North",Parent={14},Position=UDim2.new(0,5,0,0),Size=UDim2.new(1,-10,0,5),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
				{16,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(78,40,40),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="South",Parent={14},Position=UDim2.new(0,5,1,-5),Size=UDim2.new(1,-10,0,5),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
				{17,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(78,40,40),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="NorthEast",Parent={14},Position=UDim2.new(1,-5,0,0),Size=UDim2.new(0,5,0,5),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
				{18,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(78,40,40),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="East",Parent={14},Position=UDim2.new(1,-5,0,5),Size=UDim2.new(0,5,1,-10),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
				{19,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(78,40,40),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="West",Parent={14},Position=UDim2.new(0,0,0,5),Size=UDim2.new(0,5,1,-10),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
				{20,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(78,40,40),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="SouthEast",Parent={14},Position=UDim2.new(1,-5,1,-5),Size=UDim2.new(0,5,0,5),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
				{21,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(78,40,40),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="NorthWest",Parent={14},Size=UDim2.new(0,5,0,5),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
				{22,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(78,40,40),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="SouthWest",Parent={14},Position=UDim2.new(0,0,1,-5),Size=UDim2.new(0,5,0,5),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
			})
		...
		static.Init = function()
			...
			local leftFrame = create({
				{1,"Frame",{Active=true,Name="LeftSide",BackgroundColor3=Color3.fromRGB(48,26,26),BorderSizePixel=0,}},
				{2,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(70,36,36),BorderSizePixel=0,Font=3,Name="Resizer",Parent={1},Size=UDim2.new(0,5,1,0),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
				{3,"Frame",{BackgroundColor3=Color3.fromRGB(40,20,20),BorderSizePixel=0,Name="Line",Parent={2},Position=UDim2.new(0,0,0,0),Size=UDim2.new(0,1,1,0),}},
				{4,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(70,36,36),BorderSizePixel=0,Font=3,Name="WindowResizer",Parent={1},Position=UDim2.new(1,-300,0,0),Size=UDim2.new(1,0,0,4),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
				{5,"Frame",{BackgroundColor3=Color3.fromRGB(40,20,20),BorderSizePixel=0,Name="Line",Parent={4},Size=UDim2.new(1,0,0,1),}},
			})
			...
			local rightFrame = create({
				{1,"Frame",{Active=true,Name="RightSide",BackgroundColor3=Color3.fromRGB(48,26,26),BorderSizePixel=0,}},
				{2,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(70,36,36),BorderSizePixel=0,Font=3,Name="Resizer",Parent={1},Size=UDim2.new(0,5,1,0),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
				{3,"Frame",{BackgroundColor3=Color3.fromRGB(40,20,20),BorderSizePixel=0,Name="Line",Parent={2},Position=UDim2.new(0,4,0,0),Size=UDim2.new(0,1,1,0),}},
				{4,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(70,36,36),BorderSizePixel=0,Font=3,Name="WindowResizer",Parent={1},Position=UDim2.new(1,-300,0,0),Size=UDim2.new(1,0,0,4),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
				{5,"Frame",{BackgroundColor3=Color3.fromRGB(40,20,20),BorderSizePixel=0,Name="Line",Parent={4},Size=UDim2.new(1,0,0,1),}},
			})
			...
			indicator.BackgroundColor3 = Color3.fromRGB(212, 175, 55)
			...
			local leftToggle = create({{1,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(60,30,30),BorderColor3=Color3.fromRGB(40,20,20),BorderMode=2,Font=10,Name="LeftToggle",Position=UDim2.new(0,0,0,-36),Size=UDim2.new(0,16,0,36),Text="<",TextColor3=Color3.new(1,1,1),TextSize=14,}}})
			local rightToggle = leftToggle:Clone()
			rightToggle.Name = "RightToggle"
			rightToggle.Position = UDim2.new(1,-16,0,-36)
			Lib.ButtonAnim(leftToggle,{Mode = 2,PressColor = Color3.fromRGB(36,18,18)})
			Lib.ButtonAnim(rightToggle,{Mode = 2,PressColor = Color3.fromRGB(36,18,18)})
	...
	Lib.ContextMenu = (function()
		...
		local function createGui(self)
			local contextGui = create({
				...
				{2,"Frame",{Active=true,BackgroundColor3=Color3.fromRGB(40,20,20),BorderColor3=Color3.fromRGB(40,20,20),Name="Main",Parent={1},Position=UDim2.new(0.5,-100,0.5,-150),Size=UDim2.new(0,200,0,100),}},
				{3,"UICorner",{CornerRadius=UDim.new(0,4),Parent={2},}},
				{4,"Frame",{BackgroundColor3=Color3.fromRGB(48,26,26),Name="Container",Parent={2},Position=UDim2.new(0,1,0,1),Size=UDim2.new(1,-2,1,-2),}},
				{5,"UICorner",{CornerRadius=UDim.new(0,4),Parent={4},}},
				{6,"ScrollingFrame",{Active=true,BackgroundColor3=Color3.fromRGB(60,30,30),BackgroundTransparency=1,BorderSizePixel=0,CanvasSize=UDim2.new(0,0,0,0),Name="List",Parent={4},Position=UDim2.new(0,2,0,2),ScrollBarImageColor3=Color3.new(0,0,0),ScrollBarThickness=4,Size=UDim2.new(1,-4,1,-4),VerticalScrollBarInset=1,}},
				{7,"UIListLayout",{Parent={6},SortOrder=2,}},
				{8,"Frame",{BackgroundColor3=Color3.fromRGB(60,30,30),BorderSizePixel=0,Name="SearchFrame",Parent={4},Size=UDim2.new(1,0,0,24),Visible=false,}},
				{9,"Frame",{BackgroundColor3=Color3.fromRGB(42,22,22),BorderColor3=Color3.fromRGB(35,17,17),BorderSizePixel=0,Name="SearchContainer",Parent={8},Position=UDim2.new(0,3,0,3),Size=UDim2.new(1,-6,0,18),}},
				...
				{12,"Frame",{BackgroundColor3=Color3.fromRGB(40,20,20),BorderSizePixel=0,Name="Line",Parent={8},Position=UDim2.new(0,0,1,0),Size=UDim2.new(1,0,0,1),}},
				{13,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(60,30,30),BackgroundTransparency=1,BorderColor3=Color3.fromRGB(140,60,60),BorderSizePixel=0,Font=3,Name="Entry",Parent={1},Size=UDim2.new(1,0,0,22),Text="",TextSize=14,Visible=false,}},
				...
				{18,"Frame",{BackgroundColor3=Color3.fromRGB(62,32,32),BackgroundTransparency=1,BorderSizePixel=0,Name="Divider",Parent={1},Position=UDim2.new(0,0,0,20),Size=UDim2.new(1,0,0,7),Visible=false,}},
				{19,"Frame",{BackgroundColor3=Color3.fromRGB(60,30,30),BorderSizePixel=0,Name="Line",Parent={18},Position=UDim2.new(0,0,0.5,0),Size=UDim2.new(1,0,0,1),}},
	...
	Lib.CodeFrame = (function()
		...
		local function makeFrame(obj)
			local frame = create({
				{1,"Frame",{BackgroundColor3=Color3.fromRGB(44,22,22),BorderSizePixel = 0,Position=UDim2.new(0.5,-300,0.5,-200),Size=UDim2.new(0,600,0,400),}},
			})
			local elems = {}
			...
			elems.ScrollCorner = create({{1,"Frame",{BackgroundColor3=Color3.fromRGB(44,22,22),BorderSizePixel=0,Name="ScrollCorner",Position=UDim2.new(1,-16,1,-16),Size=UDim2.new(0,16,0,16),Visible=false,}}})
	...
	Lib.Checkbox = (function()
		...
		local function initGui(self,frame)
			local checkbox = frame or create({
				...
				{3,"Frame",{BackgroundColor3=Color3.fromRGB(30,15,15),BorderSizePixel=0,Name="outline",Parent={1},Size=UDim2.new(0,16,0,16),}},
				{4,"Frame",{BackgroundColor3=Color3.fromRGB(40,20,20),BorderSizePixel=0,Name="filler",Parent={3},Position=UDim2.new(0,1,0,1),Size=UDim2.new(0,14,0,14),}},
	...
	Lib.BrickColorPicker = (function()
		...
		local function createGui(self)
			local gui = create({
				...
				{2,"Frame",{Active=true,BackgroundColor3=Color3.fromRGB(48,26,26),BorderColor3=Color3.fromRGB(38,19,19),Parent={1},Position=UDim2.new(0.40000000596046,0,0.40000000596046,0),Size=UDim2.new(0,337,0,380),}},
				{3,"TextButton",{BackgroundColor3=Color3.fromRGB(68,35,35),BorderColor3=Color3.fromRGB(62,32,32),BorderSizePixel=0,Font=3,Name="MoreColors",Parent={2},Position=UDim2.new(0,5,1,-30),Size=UDim2.new(1,-10,0,25),Text="More Colors",TextColor3=Color3.new(1,1,1),TextSize=14,}},
				{4,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,Image="rbxassetid://1281023007",ImageColor3=Color3.fromRGB(85,50,50),Name="Hex",Parent={2},Size=UDim2.new(0,35,0,35),Visible=false,}},
			})
	...
	Lib.ColorPicker = (function()
		...
		local function createGui(self)
			local guiContents = create({
				{1,"Frame",{BackgroundColor3=Color3.fromRGB(48,26,26),BorderSizePixel=0,ClipsDescendants=true,Name="Content",Position=UDim2.new(0,0,0,20),Size=UDim2.new(1,0,1,-20),}},
				...
				{4,"Frame",{BackgroundColor3=Color3.fromRGB(42,22,22),BorderColor3=Color3.fromRGB(36,18,18),Name="Blue",Parent={1},Position=UDim2.new(1,-63,0,255),Size=UDim2.new(0,52,0,16),}},
				{5,"TextBox",{BackgroundColor3=Color3.fromRGB(72,37,37),BackgroundTransparency=1,BorderColor3=Color3.fromRGB(100,55,55),Font=3,Name="Input",Parent={4},Position=UDim2.new(0,2,0,0),Size=UDim2.new(0,50,0,16),Text="0",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				...
				{18,"Frame",{BackgroundColor3=Color3.fromRGB(62,32,32),BorderSizePixel=0,ClipsDescendants=true,Name="ColorSpaceFrame",Parent={1},Position=UDim2.new(1,-261,0,4),Size=UDim2.new(0,222,0,202),}},
				{19,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BorderColor3=Color3.fromRGB(100,55,55),BorderSizePixel=0,Image="rbxassetid://1072518406",Name="ColorSpace",Parent={18},Position=UDim2.new(0,1,0,1),Size=UDim2.new(0,220,0,200),}},
				...
				{25,"Frame",{BackgroundColor3=Color3.fromRGB(42,22,22),BorderColor3=Color3.fromRGB(36,18,18),Name="Green",Parent={1},Position=UDim2.new(1,-63,0,233),Size=UDim2.new(0,52,0,16),}},
				{26,"TextBox",{BackgroundColor3=Color3.fromRGB(72,37,37),BackgroundTransparency=1,BorderColor3=Color3.fromRGB(100,55,55),Font=3,Name="Input",Parent={25},Position=UDim2.new(0,2,0,0),Size=UDim2.new(0,50,0,16),Text="0",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				...
				{39,"Frame",{BackgroundColor3=Color3.fromRGB(42,22,22),BorderColor3=Color3.fromRGB(36,18,18),Name="Hue",Parent={1},Position=UDim2.new(1,-180,0,211),Size=UDim2.new(0,52,0,16),}},
				{40,"TextBox",{BackgroundColor3=Color3.fromRGB(72,37,37),BackgroundTransparency=1,BorderColor3=Color3.fromRGB(100,55,55),Font=3,Name="Input",Parent={39},Position=UDim2.new(0,2,0,0),Size=UDim2.new(0,50,0,16),Text="0",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				...
				{53,"Frame",{BackgroundColor3=Color3.new(1,1,1),BorderColor3=Color3.fromRGB(62,32,32),Name="Preview",Parent={1},Position=UDim2.new(1,-260,0,211),Size=UDim2.new(0,35,1,-245),}},
				{54,"Frame",{BackgroundColor3=Color3.fromRGB(42,22,22),BorderColor3=Color3.fromRGB(36,18,18),Name="Red",Parent={1},Position=UDim2.new(1,-63,0,211),Size=UDim2.new(0,52,0,16),}},
				{55,"TextBox",{BackgroundColor3=Color3.fromRGB(72,37,37),BackgroundTransparency=1,BorderColor3=Color3.fromRGB(100,55,55),Font=3,Name="Input",Parent={54},Position=UDim2.new(0,2,0,0),Size=UDim2.new(0,50,0,16),Text="0",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				...
				{68,"Frame",{BackgroundColor3=Color3.fromRGB(42,22,22),BorderColor3=Color3.fromRGB(36,18,18),Name="Sat",Parent={1},Position=UDim2.new(1,-180,0,233),Size=UDim2.new(0,52,0,16),}},
				{69,"TextBox",{BackgroundColor3=Color3.fromRGB(72,37,37),BackgroundTransparency=1,BorderColor3=Color3.fromRGB(100,55,55),Font=3,Name="Input",Parent={68},Position=UDim2.new(0,2,0,0),Size=UDim2.new(0,50,0,16),Text="0",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				...
				{82,"Frame",{BackgroundColor3=Color3.fromRGB(42,22,22),BorderColor3=Color3.fromRGB(36,18,18),Name="Val",Parent={1},Position=UDim2.new(1,-180,0,255),Size=UDim2.new(0,52,0,16),}},
				{83,"TextBox",{BackgroundColor3=Color3.fromRGB(72,37,37),BackgroundTransparency=1,BorderColor3=Color3.fromRGB(100,55,55),Font=3,Name="Input",Parent={82},Position=UDim2.new(0,2,0,0),Size=UDim2.new(0,50,0,16),Text="255",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				...
				{96,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(68,35,35),BorderColor3=Color3.fromRGB(62,32,32),Font=3,Name="Cancel",Parent={1},Position=UDim2.new(1,-105,1,-28),Size=UDim2.new(0,100,0,25),Text="Cancel",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,}},
				{97,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(68,35,35),BorderColor3=Color3.fromRGB(62,32,32),Font=3,Name="Ok",Parent={1},Position=UDim2.new(1,-210,1,-28),Size=UDim2.new(0,100,0,25),Text="OK",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,}},
				{98,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BorderColor3=Color3.fromRGB(62,32,32),Image="rbxassetid://1072518502",Name="ColorStrip",Parent={1},Position=UDim2.new(1,-30,0,5),Size=UDim2.new(0,13,0,200),}},
				{99,"Frame",{BackgroundColor3=Color3.fromRGB(88,46,46),BackgroundTransparency=1,BorderSizePixel=0,Name="ArrowFrame",Parent={1},Position=UDim2.new(1,-16,0,1),Size=UDim2.new(0,5,0,208),}},
			...
			local basicColors = {Color3.new(0,0,0),Color3.new(0.66666668653488,0,0),Color3.new(0,0.33333334326744,0),Color3.new(0.66666668653488,0.33333334326744,0),Color3.new(0,0.66666668653488,0),Color3.new(0.66666668653488,0.66666668653488,0),Color3.new(0,1,0),Color3.new(0.66666668653488,1,0),Color3.new(0,0,0.49803924560547),Color3.new(0.66666668653488,0,0.49803924560547),Color3.new(0,0.33333334326744,0.49803924560547),Color3.new(0.66666668653488,0.33333334326744,0.49803924560547),Color3.new(0,0.66666668653488,0.49803924560547),Color3.new(0.66666668653488,0.66666668653488,0.49803924560547),Color3.new(0,1,0.49803924560547),Color3.new(0.66666668653488,1,0.49803924560547),Color3.new(0,0,1),Color3.new(0.66666668653488,0,1),Color3.new(0,0.33333334326744,1),Color3.new(0.66666668653488,0.33333334326744,1),Color3.fromRGB(212,175,55),Color3.new(0.66666668653488,0.66666668653488,1),Color3.new(0,1,1),Color3.new(0.66666668653488,1,1),Color3.new(0.33333334326744,0,0),Color3.new(1,0,0),Color3.new(0.33333334326744,0.33333334326744,0),Color3.new(1,0.33333334326744,0),Color3.new(0.33333334326744,0.66666668653488,0),Color3.new(1,0.66666668653488,0),Color3.new(0.33333334326744,1,0),Color3.new(1,1,0),Color3.new(0.33333334326744,0,0.49803924560547),Color3.new(1,0,0.49803924560547),Color3.fromRGB(85,50,50),Color3.new(1,0.33333334326744,0.49803924560547),Color3.new(0.33333334326744,0.66666668653488,0.49803924560547),Color3.new(1,0.66666668653488,0.49803924560547),Color3.new(0.33333334326744,1,0.49803924560547),Color3.new(1,1,0.49803924560547),Color3.new(0.33333334326744,0,1),Color3.new(1,0,1),Color3.new(0.33333334326744,0.33333334326744,1),Color3.new(1,0.33333334326744,1),Color3.new(0.33333334326744,0.66666668653488,1),Color3.new(1,0.66666668653488,1),Color3.new(0.33333334326744,1,1),Color3.new(1,1,1)}
			local customColors = {}
			
			local colorChoice = Instance.new("TextButton")
			colorChoice.Name = "Choice"
			colorChoice.Size = UDim2.new(0,25,0,18)
			colorChoice.BorderColor3 = Color3.fromRGB(62,32,32)
			colorChoice.Text = ""
	...
	Lib.NumberSequenceEditor = (function()
		...
		local function new()
			...
			local guiContents = create({
				{1,"Frame",{BackgroundColor3=Color3.fromRGB(48,26,26),BorderSizePixel=0,ClipsDescendants=true,Name="Content",Position=UDim2.new(0,0,0,20),Size=UDim2.new(1,0,1,-20),}},
				{2,"Frame",{BackgroundColor3=Color3.fromRGB(42,22,22),BorderColor3=Color3.fromRGB(36,18,18),Name="Time",Parent={1},Position=UDim2.new(0,40,0,210),Size=UDim2.new(0,60,0,20),}},
				{3,"TextBox",{BackgroundColor3=Color3.fromRGB(72,37,37),BackgroundTransparency=1,BorderColor3=Color3.fromRGB(100,55,55),ClipsDescendants=true,Font=3,Name="Input",Parent={2},Position=UDim2.new(0,2,0,0),Size=UDim2.new(0,58,0,20),Text="0",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				...
				{5,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(68,35,35),BorderColor3=Color3.fromRGB(62,32,32),Font=3,Name="Close",Parent={1},Position=UDim2.new(1,-90,0,210),Size=UDim2.new(0,80,0,20),Text="Close",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,}},
				{6,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(68,35,35),BorderColor3=Color3.fromRGB(62,32,32),Font=3,Name="Reset",Parent={1},Position=UDim2.new(1,-180,0,210),Size=UDim2.new(0,80,0,20),Text="Reset",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,}},
				{7,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(68,35,35),BorderColor3=Color3.fromRGB(62,32,32),Font=3,Name="Delete",Parent={1},Position=UDim2.new(0,380,0,210),Size=UDim2.new(0,80,0,20),Text="Delete",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,}},
				{8,"Frame",{BackgroundColor3=Color3.fromRGB(48,26,26),BorderColor3=Color3.fromRGB(62,32,32),Name="NumberLineOutlines",Parent={1},Position=UDim2.new(0,10,0,20),Size=UDim2.new(1,-20,0,170),}},
				{9,"Frame",{BackgroundColor3=Color3.fromRGB(72,37,37),BackgroundTransparency=1,BorderColor3=Color3.fromRGB(100,55,55),Name="NumberLine",Parent={1},Position=UDim2.new(0,10,0,20),Size=UDim2.new(1,-20,0,170),}},
				{10,"Frame",{BackgroundColor3=Color3.fromRGB(42,22,22),BorderColor3=Color3.fromRGB(36,18,18),Name="Value",Parent={1},Position=UDim2.new(0,170,0,210),Size=UDim2.new(0,60,0,20),}},
				...
				{12,"TextBox",{BackgroundColor3=Color3.fromRGB(72,37,37),BackgroundTransparency=1,BorderColor3=Color3.fromRGB(100,55,55),ClipsDescendants=true,Font=3,Name="Input",Parent={10},Position=UDim2.new(0,2,0,0),Size=UDim2.new(0,58,0,20),Text="0",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				{13,"Frame",{BackgroundColor3=Color3.fromRGB(42,22,22),BorderColor3=Color3.fromRGB(36,18,18),Name="Envelope",Parent={1},Position=UDim2.new(0,300,0,210),Size=UDim2.new(0,60,0,20),}},
				{14,"TextBox",{BackgroundColor3=Color3.fromRGB(72,37,37),BackgroundTransparency=1,BorderColor3=Color3.fromRGB(100,55,55),ClipsDescendants=true,Font=3,Name="Input",Parent={13},Position=UDim2.new(0,2,0,0),Size=UDim2.new(0,58,0,20),Text="0",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
	...
	Lib.ColorSequenceEditor = (function()
		...
		local function new()
			...
			local guiContents = create({
				{1,"Frame",{BackgroundColor3=Color3.fromRGB(48,26,26),BorderSizePixel=0,ClipsDescendants=true,Name="Content",Position=UDim2.new(0,0,0,20),Size=UDim2.new(1,0,1,-20),}},
				{2,"Frame",{BackgroundColor3=Color3.fromRGB(48,26,26),BorderColor3=Color3.fromRGB(62,32,32),Name="ColorLine",Parent={1},Position=UDim2.new(0,10,0,5),Size=UDim2.new(1,-20,0,70),}},
				...
				{7,"Frame",{BackgroundColor3=Color3.fromRGB(42,22,22),BorderColor3=Color3.fromRGB(36,18,18),Name="Time",Parent={1},Position=UDim2.new(0,40,0,95),Size=UDim2.new(0,100,0,20),}},
				{8,"TextBox",{BackgroundColor3=Color3.fromRGB(72,37,37),BackgroundTransparency=1,BorderColor3=Color3.fromRGB(100,55,55),ClipsDescendants=true,Font=3,Name="Input",Parent={7},Position=UDim2.new(0,2,0,0),Size=UDim2.new(0,98,0,20),Text="0",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				...
				{10,"Frame",{BackgroundColor3=Color3.new(1,1,1),BorderColor3=Color3.fromRGB(62,32,32),Name="ColorBox",Parent={1},Position=UDim2.new(0,220,0,95),Size=UDim2.new(0,20,0,20),}},
				...
				{12,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(68,35,35),BorderColor3=Color3.fromRGB(62,32,32),BorderSizePixel=0,Font=3,Name="Close",Parent={1},Position=UDim2.new(1,-90,0,95),Size=UDim2.new(0,80,0,20),Text="Close",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,}},
				{13,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(68,35,35),BorderColor3=Color3.fromRGB(62,32,32),BorderSizePixel=0,Font=3,Name="Reset",Parent={1},Position=UDim2.new(1,-180,0,95),Size=UDim2.new(0,80,0,20),Text="Reset",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,}},
				{14,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(68,35,35),BorderColor3=Color3.fromRGB(62,32,32),BorderSizePixel=0,Font=3,Name="Delete",Parent={1},Position=UDim2.new(0,280,0,95),Size=UDim2.new(0,80,0,20),Text="Delete",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,}},
...
local function main()
	...
	Properties.NewPropEntry = function(index)
		...
		-- FIX: Forward mouse wheel from Properties entry TextButtons to scrollbar
		newEntry.MouseWheelForward:Connect(function()
			if scrollV then scrollV:ScrollTo(scrollV.Index - scrollV.WheelIncrement) end
		end)
		newEntry.MouseWheelBackward:Connect(function()
	...
	Properties.InitInputBox = function()
		inputBox = create({
			{1,"Frame",{BackgroundColor3=Color3.fromRGB(42,22,22),BorderSizePixel=0,Name="InputBox",Size=UDim2.new(0,200,0,22),Visible=false,ZIndex=2,}},
			{2,"TextBox",{BackgroundColor3=Color3.fromRGB(48,26,26),BackgroundTransparency=1,BorderColor3=Color3.fromRGB(212,175,55),BorderSizePixel=0,ClearTextOnFocus=false,Font=3,Parent={1},PlaceholderColor3=Color3.new(0.69803923368454,0.69803923368454,0.69803923368454),Position=UDim2.new(0,3,0,0),Size=UDim2.new(1,-6,1,0),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,ZIndex=2,}},
		})
	...
	Properties.InitEntryStuff = function()
		Properties.EntryTemplate = create({
			{1,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(48,26,26),BorderColor3=Color3.fromRGB(38,19,19),Font=3,Name="Entry",Position=UDim2.new(0,1,0,1),Size=UDim2.new(0,250,0,22),Text="",TextSize=14,}},
			{2,"Frame",{BackgroundColor3=Color3.fromRGB(112,39,39),BackgroundTransparency=1,BorderColor3=Color3.fromRGB(140,60,60),BorderSizePixel=0,Name="NameFrame",Parent={1},Position=UDim2.new(0,20,0,0),Size=UDim2.new(1,-40,1,0),}},
			...
			{7,"Frame",{BackgroundColor3=Color3.fromRGB(112,39,39),BackgroundTransparency=1,BorderColor3=Color3.new(0.33725491166115,0.49019607901573,0.73725491762161),BorderSizePixel=0,Name="ValueFrame",Parent={1},Position=UDim2.new(1,-100,0,0),Size=UDim2.new(0,80,1,0),}},
			{8,"Frame",{BackgroundColor3=Color3.fromRGB(40,20,20),BorderColor3=Color3.fromRGB(140,60,60),BorderSizePixel=0,Name="Line",Parent={7},Position=UDim2.new(0,-1,0,0),Size=UDim2.new(0,1,1,0),}},
			...
			{22,"Frame",{BackgroundColor3=Color3.fromRGB(88,46,46),BorderSizePixel=0,Name="TimeLine",Parent={19},Position=UDim2.new(0,26,0.5,-1),Size=UDim2.new(1,-34,0,2),}},
			{23,"Frame",{BackgroundColor3=Color3.fromRGB(68,35,35),BorderColor3=Color3.fromRGB(38,19,19),Name="Slider",Parent={22},Position=UDim2.new(0,-4,0,-8),Size=UDim2.new(0,8,0,18),}},
			...
			{26,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(68,35,35),BorderSizePixel=0,Font=3,Name="RowButton",Parent={1},Size=UDim2.new(1,0,1,0),Text="Add Attribute",TextColor3=Color3.new(1,1,1),TextSize=14,TextTransparency=0.10000000149012,Visible=false,}},
		})
...
local function main()
	...
	SaveInstance.Init = function()
		...
		ListFrame.TopImage = ""
		ListFrame.ScrollBarImageColor3 = Color3.fromRGB(78, 40, 40)
...
DefaultSettings = (function()
	...
	return {
		...
		Theme = {
			...
			Main1 = rgb(60,30,30),
			Main2 = rgb(45,25,25),
			Outline1 = rgb(35,20,20), -- Mainly frames
			Outline2 = rgb(65,35,35), -- Mainly button
			Outline3 = rgb(30,18,18), -- Mainly textbox
			TextBox = rgb(38,22,22),
			Menu = rgb(32,18,18),
			ListSelection = rgb(112,39,39),
			Button = rgb(70,35,35),
			ButtonHover = rgb(85,42,42),
			ButtonPress = rgb(50,25,25),
			Highlight = rgb(90,45,45),
...
Main = (function()
	...
	Main.Elevated = false
	Main.MissingEnv = {}
	Main.Version = "Elite Explorer v2.1"
	Main.Mouse = plr:GetMouse()
	Main.AppControls = {}
	Main.Apps = Apps
	Main.MenuApps = {}
	Main.GitName = "EliteLevelSkripts"
	Main.RepoName = "EliteExplorer"
	...
	Main.FetchAPI = function()
		...
		if Main.Elevated then
			...
			rawAPI = rawAPI or (function() local s,r = pcall(game.HttpGet, game, "http://setup.roblox.com/"..Main.RobloxVersion.."-API-Dump.json"); return s and r or nil end)()
			rawAPI = rawAPI or game:HttpGet("https://raw.githubusercontent.com/MaximumADHD/Roblox-Client-Tracker/roblox/Full-API-Dump.json")
		else
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			{2,"Frame",{Active=true,BackgroundColor3=Color3.fromRGB(60,30,30),BorderSizePixel=0,Name="Main",Parent={1},Position=UDim2.new(0.5,-175,0.5,-100),Size=UDim2.new(0,350,0,200),}},
			{3,"Frame",{BackgroundColor3=Color3.fromRGB(48,26,26),BorderSizePixel=0,ClipsDescendants=true,Name="Holder",Parent={2},Size=UDim2.new(1,0,1,0),}},
			...
			{5,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Title",Parent={3},Position=UDim2.new(0,-190,0,15),Size=UDim2.new(0,100,0,50),Text="ELX",TextColor3=Color3.new(1,1,1),TextSize=50,TextTransparency=1,}},
			{6,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Desc",Parent={3},Position=UDim2.new(0,-230,0,60),Size=UDim2.new(0,180,0,25),Text="Elite Level Explorer",TextColor3=Color3.new(1,1,1),TextSize=18,TextTransparency=1,}},
			...
			{8,"Frame",{BackgroundColor3=Color3.fromRGB(60,30,30),BorderSizePixel=0,Name="ProgressBar",Parent={3},Position=UDim2.new(0,110,0,145),Size=UDim2.new(0,0,0,4),}},
			{9,"Frame",{BackgroundColor3=Color3.fromRGB(212,175,55),BorderSizePixel=0,Name="Bar",Parent={8},Size=UDim2.new(0,0,1,0),}},
			{10,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image="rbxassetid://2764171053",ImageColor3=Color3.fromRGB(48,26,26),Parent={8},ScaleType=1,Size=UDim2.new(1,0,1,0),SliceCenter=Rect.new(2,2,254,254),}},
			{11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Creator",Parent={2},Position=UDim2.new(1,-110,1,-20),Size=UDim2.new(0,105,0,20),Text="Elite Level Scripts",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=1,}},
	...
	Main.SetMainGuiOpen = function(val)
		...
		Main.MainGui.OpenButton.Text = val and "X" or "ELX"
	...
	Main.CreateMainGui = function()
		local gui = create({
			...
			{2,"TextButton",{AnchorPoint=Vector2.new(0.5,0),AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(112,39,39),BorderSizePixel=0,Font=4,Name="OpenButton",Parent={1},Position=UDim2.new(0.5,0,0,2),Size=UDim2.new(0,32,0,32),Text="ELX",TextColor3=Color3.new(1,1,1),TextSize=16,TextTransparency=0.20000000298023,}},
			{3,"UICorner",{CornerRadius=UDim.new(0,4),Parent={2},}},
			{4,"Frame",{AnchorPoint=Vector2.new(0.5,0),BackgroundColor3=Color3.fromRGB(48,26,26),ClipsDescendants=true,Name="MainFrame",Parent={2},Position=UDim2.new(0.5,0,1,-4),Size=UDim2.new(0,224,0,200),}},
			{5,"UICorner",{CornerRadius=UDim.new(0,4),Parent={4},}},
			{6,"Frame",{BackgroundColor3=Color3.fromRGB(60,30,30),Name="BottomFrame",Parent={4},Position=UDim2.new(0,0,1,-24),Size=UDim2.new(1,0,0,24),}},
			{7,"UICorner",{CornerRadius=UDim.new(0,4),Parent={6},}},
			{8,"Frame",{BackgroundColor3=Color3.fromRGB(60,30,30),BorderSizePixel=0,Name="CoverFrame",Parent={6},Size=UDim2.new(1,0,0,4),}},
			{9,"Frame",{BackgroundColor3=Color3.fromRGB(38,19,19),BorderSizePixel=0,Name="Line",Parent={8},Position=UDim2.new(0,0,0,-1),Size=UDim2.new(1,0,0,1),}},
			...
			{14,"ScrollingFrame",{Active=true,AnchorPoint=Vector2.new(0.5,0),BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderColor3=Color3.fromRGB(38,19,19),BorderSizePixel=0,Name="AppsFrame",Parent={4},Position=UDim2.new(0.5,0,0,0),ScrollBarImageColor3=Color3.new(0,0,0),ScrollBarThickness=4,Size=UDim2.new(0,222,1,-25),}},
			...
			{18,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(68,35,35),BorderSizePixel=0,Font=3,Name="Main",Parent={17},Size=UDim2.new(1,0,0,60),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
			...
			{21,"Frame",{BackgroundColor3=Color3.fromRGB(212,175,55),BorderSizePixel=0,Name="Highlight",Parent={18},Position=UDim2.new(0,0,1,-2),Size=UDim2.new(1,0,0,2),}},
		})
		Main.MainGui = gui
